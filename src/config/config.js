System.register(['@angular/core', 'rxjs/add/operator/share', 'rxjs/add/operator/debounce', 'rxjs/Rx', './const'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, Rx_1, const_1;
    var ResponsiveConfig, ResponsiveState;
    return {
        setters:[
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function() {
            ...
            exports_1("ResponsiveConfig", ResponsiveConfig);
            ...
            exports_1("ResponsiveState", ResponsiveState);
        }
    }
});
