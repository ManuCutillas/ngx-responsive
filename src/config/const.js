System.register([], function(exports_1, context_1) {
    ...
    var GLOBAL_INPUTS, REG_WEARABLES, REG_MOBILES, REG_TABLETS, REG_SMARTS_TV, REG_GAME_DEVICES, REG_BROWSERS, REG_OS, REG_SORT_NAMES, WINDOWS_OS_VERSION, MAC_OS_VERSION, LINUX_OS, REG_BOTS;
    return {
        setters:[],
        execute: function() {
            exports_1("GLOBAL_INPUTS", GLOBAL_INPUTS = {
            ...
            exports_1("REG_WEARABLES", REG_WEARABLES = {
                IWATCH: ''
            });
            exports_1("REG_MOBILES", REG_MOBILES = {
                ANDROID: /(android);?[\s\/]+([\d.]+)?/,
            ...
            exports_1("REG_TABLETS", REG_TABLETS = {
                IPAD: /(ipad).*os\s([\d_]+)/,
            ...
            exports_1("REG_SMARTS_TV", REG_SMARTS_TV = {
                CHROMECAST: /crkey/i,
                APPLE_TV: /appletv/i,
            ...
            exports_1("REG_GAME_DEVICES", REG_GAME_DEVICES = {
                PS4: /playstation 4/i,
                PS3: /playstation 3/i,
                XBOX: /xbox one/i,
                XBOX_ONE: /xbox/i,
            ...
            exports_1("REG_BROWSERS", REG_BROWSERS = {
            ...
            exports_1("REG_SORT_NAMES", REG_SORT_NAMES = {
                MOZILLA: /mozilla/,
                CHROME: /chrome/,
                WEBKIT: [/webkit/, /applewebkit/],
                SAFARI: /safari/
            });
            exports_1("WINDOWS_OS_VERSION", WINDOWS_OS_VERSION = {
                WINDOWS_3_11: /win16/,
            ...
            exports_1("MAC_OS_VERSION", MAC_OS_VERSION = {
                MAC_OS: '',
            });
            exports_1("LINUX_OS", LINUX_OS = {
                DEBIAN: /Debian/i,
                KNOPPIX: /Knoppix/i,
                MINT: /Mint/i,
                UBUNTU: /Ubuntu/i,
