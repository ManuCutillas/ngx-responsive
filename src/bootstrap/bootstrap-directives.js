System.register(['@angular/core', '../config/config', '../config/responsive-base'], function(exports_1, context_1) {
    ...
    var XL, LG, MD, SM, XS, ShowItBootstrap, HideItBootstrap, ResponsiveSizeInfo;
    return {
        setters:[
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function() {
            ...
            exports_1("XS", XS);
            ShowItBootstrap = (function (_super) {
            ...
            exports_1("ShowItBootstrap", ShowItBootstrap);
            HideItBootstrap = (function (_super) {
            ...
            exports_1("HideItBootstrap", HideItBootstrap);
            ResponsiveSizeInfo = (function () {
            ...
            exports_1("ResponsiveSizeInfo", ResponsiveSizeInfo);
        }
    }
});
